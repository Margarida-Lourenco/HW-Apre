...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{./Part II/5.png}
...
\vspace{10pt}
When analizing MAE values, the smaller the MAE the better the models performance. With that being said, the best combination for heatmap is:

\begin{itemize}
    \item Figure 4 (a): Learning Rate = 0.01 and Batch Size = 64
    \item Figure 4 (b): Learning Rate = 0.01 and Batch Size = 64
    \item Figure 4 (c): Learning Rate = 0.01 and Batch Size = 32
\end{itemize}
